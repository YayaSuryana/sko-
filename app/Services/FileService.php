...
class FileService
{
    ...
    public function uploadFoto(\Illuminate\Http\UploadedFile $file)
    {
        return $this->executeUpload($file, 'foto');
    }
    ...
    // Controller Atlet
    public function deleteFoto(Atlet $atlet)
    {
        $filepath = 'public/foto/' . $atlet->foto;
        return $this->executeDeleteFromStorage($filepath);
    }
