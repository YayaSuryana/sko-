      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fa fa-fa-solid fa-grid-2-plus"></i> {{ $fullTitle }}</h4>
          </div>
          <div class="card-body">
            <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
				<div class="col-md-6">
                  @include('stisla.includes.forms.inputs.input', ['required'=>true, 'type'=>'text', 'id'=>'nama', 'name'=>'nama', 'label'=>__('Cabor')])
                </div>
