  ...
  <div class="section-body">
    ...
    <div class="row">
      <div class="col-12">
                  ...
                  <tbody>
                    @foreach ($data as $item)
                      <tr>
                        ...
                        <td>
                          @if ($canUpdate)
                            @include('stisla.includes.forms.buttons.btn-edit', ['link' => route('prestasis.edit', [$item->id])])
                          @endif
                          @if ($canDelete)
                            @include('stisla.includes.forms.buttons.btn-delete', ['link' => route('prestasis.destroy', [$item->id])])
                          @endif
                        </td>
                      </tr>
                    @endforeach
        ...
        @else
          @include('stisla.includes.others.empty-state', ['title' => 'Data ' . $title, 'icon' => '', 'link' => $routeCreate])
        @endif
      </div>
