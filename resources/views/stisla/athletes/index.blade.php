                  ...
                  <tbody>
                    @foreach ($data as $item)
                      <tr>
                        ...
                        <td>
                          @if ($canUpdate)
                            @include('stisla.includes.forms.buttons.btn-edit', ['link' => route('athletes.edit', [$item->id])])
                          @endif
                          @if ($canDelete)
                            @include('stisla.includes.forms.buttons.btn-delete', ['link' => route('athletes.destroy', [$item->id])])
                          @endif
                        </td>
                      </tr>
                    @endforeach
