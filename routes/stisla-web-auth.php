...
// MY ROUTE
use App\Http\Controllers\ProfileatletController;
...
// ROUTE PPLP
use App\Http\Controllers\pplp\PplpController;
use App\Http\Controllers\pplp\PplpStatistikController;

// ROUTE SKO
use App\Http\Controllers\sko\SkoController;
use App\Http\Controllers\sko\SkoStatistikController;
...
Route::resource('profileatlets', ProfileatletController::class);
Route::resource('masterevents', MastereventController::class);
Route::resource('events', EventController::class);
Route::resource('prestasis', PrestasiController::class);
Route::resource('kodes', KodeController::class);
// Route PPLP
Route::resource('pplp', PplpController::class);
Route::get('pplp-statistik', [PplpStatistikController::class,'statistik'])->name('statistik.pplp');

// Route SKO
Route::resource('sko', SkoController::class);
Route::get('sko-statistik', [SkoStatistikController::class,'statistik'])->name('statistik.sko');
Route::get('atlet/{id}', [ShowController::class, 'show'])->name('detail.atlet');
...
Route::get('show/document/{id}', [DocumentController::class, 'show'])->name('showDocument');
